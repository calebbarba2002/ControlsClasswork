...
# controller = A_arm.ControllerLoopshaped()
# # TODO: decide whether to use 50 or 30 (like old solution) for HWs 10-14
...
arm = A_arm.Dynamics(alpha=0.1)
controller = A_arm.ControllerLoopshaped()
theta_ref = common.SignalGenerator(amplitude=np.radians(30), frequency=0.05)
d_force = np.array([0.1])
theta_noise = common.SignalGenerator(amplitude=0.01)

...
class YourSystemControllerPD(ControllerBase):
    """
    Example:
    ...
    def __init__(self):
        ...
        # tr = 1.5        # Rise time (seconds) - how fast to reach target
        ...
        # G(s) = b0 / (s^2 + a1*s + a0)
        b0 = P.tf_num[-1]  # Numerator coefficient
        a1, a0 = P.tf_den[-2:]  # Denominator coefficients
    ...
    def update_with_state(self, r, x):
        ...
        # u = self.saturate(u, u_max=P.input_max)
